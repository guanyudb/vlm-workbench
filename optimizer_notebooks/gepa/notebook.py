...
class TaskModel:
    ...
    def _load_hf(self):
        ...
        # HF token: scope/key configurable via YAML so a different workspace
        # can ship without editing the notebook source. Defaults preserved for
        # backwards compatibility with the original deploy.
